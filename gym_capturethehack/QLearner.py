...
class QLearner:
    def __init__(self, number_of_team_members):
        ...
        self.fc1 = tf.layers.dense(self.flat, units=1200, activation=tf.nn.elu, name="fc1")
    ...
    def optimize(self, img, target_Q):
        _, l = self.sess.run([self.train, self.loss], feed_dict={self.next_q: target_Q, self.img: img})
        return l
